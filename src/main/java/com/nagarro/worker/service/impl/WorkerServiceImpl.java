...
public class WorkerServiceImpl implements WorkerService {
	...
	public void populateData() {
		...
		worker1.setServiceCategory(ServiceCategory.APPLIANCE_REPAIR);
		...
		worker2.setServiceCategory(ServiceCategory.ELECTRICIAN);
		Worker worker3 = new Worker();
		worker3.setId(3);
		worker3.setName("Kamlesh");
		worker3.setEmail("kamlesh@uc.com");
		worker3.setCity("Delhi");
		worker3.setServiceCategory(ServiceCategory.PLUMBER);
